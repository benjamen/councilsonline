...
bench --site your-site-name execute lodgeick.lodgeick.fixtures.taytay.import_taytay_fixtures.import_fixtures
```
...
Update `/workspace/development/frappe-bench/apps/lodgeick/lodgeick/hooks.py`:
...
```python
# lodgeick/patches/v1_3/import_taytay_fixtures.py
import frappe
from lodgeick.lodgeick.fixtures.taytay.import_taytay_fixtures import import_fixtures
...
```
lodgeick.patches.v1_3.import_taytay_fixtures
```
...
# Import fixtures
bench --site production-site execute lodgeick.lodgeick.fixtures.taytay.import_taytay_fixtures.import_fixtures
...
bench --site lodgeick.localhost export-doc Council "TAYTAY-PH"

# Copy to fixtures directory
cp lodgeick/lodgeick/council/taytay_ph/taytay_ph.json lodgeick/lodgeick/fixtures/taytay/taytay_council.json

# Re-export SPISC
bench --site lodgeick.localhost export-doc "Request Type" "Social Pension for Indigent Senior Citizens (SPISC)"

# Copy to fixtures directory
cp "lodgeick/lodgeick/request_type/social_pension_for_indigent_senior_citizens_(spisc)/social_pension_for_indigent_senior_citizens_(spisc).json" lodgeick/lodgeick/fixtures/taytay/spisc_request_type.json
```
...
2. Verify the backend API: `lodgeick/api.py::get_request_type_steps()`
