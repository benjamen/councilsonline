...
def run_tests(test_suite, test_type="All", test_file=None):
	...
	frappe.enqueue(
		method="lodgeick.lodgeick.doctype.test_runner.test_runner.execute_tests",
...
def execute_tests(test_runner_name):
	...
	try:
		# Get app path
		app_path = frappe.get_app_path("lodgeick")
