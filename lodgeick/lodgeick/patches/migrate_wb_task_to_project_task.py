...
Migrates all WB Tasks linked to Lodgeick Assessment Projects to Project Tasks
"""
...
def execute():
	"""Migrate WB Tasks linked to Lodgeick to Project Tasks"""

	# Only migrate Lodgeick-related tasks (linked to Assessment Projects)
