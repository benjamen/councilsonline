<template>
  <div>
    ...
    <div class="space-y-8">
      <!-- Permitted Boundary Activity (PBA) Section -->
      <PBASection v-model="localData" />

      <!-- Affected Parties Section -->
      <AffectedPartiesSection v-model="localData" />

      <!-- Guidance -->
      <InfoBox title="Affected Parties Guidance" variant="warning">
