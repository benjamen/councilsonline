<template>
  <div>
    ...
    <div class="space-y-6">
      ...
      <!-- Delivery & Payment -->
      <div class="border-t border-gray-200 pt-6 mt-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Delivery & Payment</h3>
        <p class="text-sm text-gray-600 mb-6">Specify payment and invoice details</p>
        ...
        <div class="space-y-6">
          ...
          <div class="border-t border-gray-200 pt-6">
            <h4 class="text-base font-semibold text-gray-900 mb-4">Invoice Details</h4>
