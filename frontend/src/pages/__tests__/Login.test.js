...
vi.mock("frappe-ui", () => ({
	...
	Input: {
		...
		template:
			'<input :id="id" :name="name" :type="type" :required="required" :placeholder="placeholder" :value="modelValue" />',
	},
}))
...
describe("Login", () => {
	...
	it("renders header with correct text", () => {
		...
		expect(wrapper.text()).toContain("Sign in to your CouncilsOnline account")
	})
	...
	it("renders email input field with correct attributes", () => {
		...
		expect(emailInput.attributes("placeholder")).toBe(
			"Administrator or you@example.com",
		)
	})
