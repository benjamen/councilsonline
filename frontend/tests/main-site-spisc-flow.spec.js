...
test.describe('Main Site SPISC Flow', () => {
  test('should complete SPISC application from main site', async ({ page }) => {
    ...
    await page.goto('http://localhost:8080/frontend/request/new', { waitUntil: 'networkidle' });
  ...
  test('should handle back navigation correctly', async ({ page }) => {
    ...
    await page.goto('http://localhost:8080/frontend/request/new?council=TAYTAY-PH', { waitUntil: 'networkidle' });
