...
test.describe('Dual Login Flow - Council-Specific Authentication', () => {
  test.describe('Council Landing Page', () => {
    test('should display login and register buttons when not logged in', async ({ page }) => {
    ...
    test('should navigate to council login page', async ({ page }) => {
      ...
      await expect(page).toHaveURL(`/frontend/council/${TEST_COUNCIL_CODE}/login`)
    ...
    test('should navigate to council register page', async ({ page }) => {
      ...
      await expect(page).toHaveURL(`/frontend/council/${TEST_COUNCIL_CODE}/register`)
  ...
  test.describe('Council Login Page', () => {
    ...
    test('should navigate to forgot password page', async ({ page }) => {
      ...
      await expect(page).toHaveURL(`/frontend/council/${TEST_COUNCIL_CODE}/forgot-password`)
  ...
  test.describe('Council Registration Page', () => {
    test('should display registration form with council locked', async ({ page }) => {
  ...
  test.describe('Council Context Persistence', () => {
    test('should maintain council lock across navigation', async ({ page }) => {
      ...
      await page.click('text=Forgot password?')
      expect(page.url()).toContain(`/council/${TEST_COUNCIL_CODE}/forgot-password`)
...
test.describe('Dual Login Flow - System-Wide vs Council-Specific', () => {
  test('system-wide login URL should differ from council login', async ({ page }) => {
  ...
  test('council landing should not show system-wide elements', async ({ page }) => {
    await page.goto(`/frontend/council/${TEST_COUNCIL_CODE}`)
