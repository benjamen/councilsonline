...
const TEST_APPLICATION_DATA = {
  ...
  activity_description: 'Proposed construction of a two-storey dwelling on a sloping site',
  ...
  aee_full_assessment: 'The proposed development will have minimal environmental effects due to existing urban character',
  ...
  mitigation_measures: 'Landscaping screen on northern boundary, construction hours limited to 7am-6pm',

  // Step 8: Proposed Conditions
  conditions_text: '1. Construction hours limited to 7am-6pm weekdays\n2. Erosion and sediment control plan required',
...
test.describe('Resource Consent Application - E2E Flow', () => {
  ...
  test('should navigate to new RC application', async ({ page }) => {
    ...
    const newAppButton = page.getByRole('button', { name: /new application|start application|create request/i }).first()
  ...
  test('should display natural hazard checkboxes in Step 4', async ({ page }) => {
    const hazards = [
      'Flood',
      'Earthquake',
      'Landslip',
  ...
  test('should display rich text editor for AEE in Step 6', async ({ page }) => {
  ...
  test('should navigate to Review screen (Step 10)', async ({ page }) => {
    ...
    const reviewButton = page.getByRole('button', { name: /review|review & submit/i }).first()
  ...
  test('should display consent type badges in Review screen', async ({ page }) => {
  ...
  test('should display natural hazard badges with icons', async ({ page }) => {
    ...
    const hazardBadges = page.locator('[class*="hazard"], [class*="bg-blue-100"]').first()
    console.log('Checking for natural hazard badges')
  })

  test('should display declaration checkmarks in Review screen', async ({ page }) => {
  ...
  test('should show Submit button on Review screen', async ({ page }) => {
    const submitButton = page.getByRole('button', { name: /submit|send|create application/i }).first()
...
test.describe('Resource Consent - Mobile Responsive Tests', () => {
  ...
  test('should stack application summary vertically on mobile', async ({ page }) => {
...
test.describe('Resource Consent - API Integration Tests', () => {
  ...
  test('should submit application and create RC Application DocType', async ({ page }) => {
...
test.describe('Resource Consent - Accessibility Tests', () => {
  ...
  test('should have sufficient color contrast', async ({ page }) => {
    ...
    console.log('Color contrast check - requires manual verification or axe-core')
  })
...
test.describe('Resource Consent - Performance Tests', () => {
  ...
  test('should render 90 fields without performance issues', async ({ page }) => {
    await page.goto(FRONTEND_URL)
