...
test.describe("Council Website Flow", () => {
	test("should complete SPISC application from council website link", async ({
		page,
	}) => {
	...
	test("should handle multiple request types from council link", async ({
		page,
	}) => {
	...
	test("should preserve council selection throughout flow", async ({
		page,
	}) => {
