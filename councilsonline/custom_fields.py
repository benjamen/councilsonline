...
def create_councilsonline_custom_fields():
	...
	custom_fields = {
		...
		"Request": [
			...
			{
				"fieldname": "councilsonline_company_section",
				"fieldtype": "Section Break",
			...
			},
			{
				...
				"insert_after": "councilsonline_company_section",
			...
			{
				"fieldname": "councilsonline_disbursements_section",
				"fieldtype": "Section Break",
				"label": "Disbursements",
			...
			},
			{
				...
				"insert_after": "councilsonline_disbursements_section"
			},
			{
				"fieldname": "councilsonline_total_costing_section",
				"fieldtype": "Section Break",
				"label": "Total Costing",
			...
			},
			{
				...
				"insert_after": "councilsonline_total_costing_section",
				"read_only": 1,
		...
		"User": [
			{
				"fieldname": "councilsonline_account_section",
				"fieldtype": "Section Break",
			...
			},
			{
				...
				"label": "Account Type",
				"options": "\nApplicant\nAgent",
				"insert_after": "councilsonline_account_section",
			...
			{
				"fieldname": "councilsonline_council_section",
				"fieldtype": "Section Break",
			...
			},
			{
				...
				"options": "Council",
				"insert_after": "councilsonline_council_section",
				"description": "Your preferred council for new requests"
			},
			{
				"fieldname": "councilsonline_philippines_section",
				"fieldtype": "Section Break",
			...
			},
			{
				...
				"fieldtype": "Data",
				"label": "Barangay",
				"insert_after": "councilsonline_philippines_section",
				"depends_on": "eval:doc.country_of_residence=='Philippines'",
...
if __name__ == "__main__":
	...
	frappe.connect()
	create_councilsonline_custom_fields()
