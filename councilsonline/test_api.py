#!/usr/bin/env python3
"""
Test CouncilsOnline API endpoints
Run with: bench --site councilsonline.localhost execute councilsonline.test_api
"""
...
def test_whitelisted_methods():
    ...
    try:
        from councilsonline.councilsonline.doctype.request.request import get_my_applications
    ...
    try:
        from councilsonline.councilsonline.doctype.payment.payment import calculate_outstanding_amount
    ...
    try:
        from councilsonline.councilsonline.doctype.payment.payment import get_request_payments
    ...
    try:
        from councilsonline.councilsonline.doctype.request_for_information.request_for_information import get_request_rfis
    ...
    try:
        from councilsonline.councilsonline.doctype.communication_log.communication_log import get_request_communications
...
def run_all_tests():
    """Run all tests"""
    print("\n" + "="*60)
    print("  COUNCILSONLINE API TESTING SUITE")
    print("="*60)
