"""
Regression Test Suite for CouncilsOnline v1.3+ Critical Bugs
...
RELEASE REQUIREMENT: Run with --failfast flag:
    bench --site councilsonline.localhost run-tests --module councilsonline.tests.test_regression_bugs_v1_3 --failfast
"""
...
from councilsonline.tests.test_helpers import (
    create_test_council,
    create_test_request,
...
from councilsonline.api import create_spisc_application
...
class TestBug002CouncilMeetingDoctype(FrappeTestCase):
    ...
    def test_bug_002_council_meeting_python_class_name(self):
        ...
        """
        try:
            from councilsonline.councilsonline.doctype.council_meeting.council_meeting import (
                CouncilMeeting
            )
    ...
    def test_bug_002_council_meeting_api_endpoints(self):
        ...
        """
        try:
            from councilsonline.api import book_council_meeting
...
def run_regression_suite():
    ...
    Use this from console:
        bench --site councilsonline.localhost run-tests \
            --module councilsonline.tests.test_regression_bugs_v1_3 \
            --failfast
    """
