...
def get_step_templates():
	...
	"""
	try:
		from councilsonline.templates.step_templates import list_available_templates, get_template_info
...
def load_step_template(template_name):
	...
	"""
	try:
		from councilsonline.templates.step_templates import load_template
