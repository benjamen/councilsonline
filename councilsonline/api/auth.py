...
def register_user(
    ...
    """
    Register a new REQUESTER for CouncilsOnline (requesters can submit on behalf of themselves or organizations)
...
def register_agent(
    ...
    """
    Register a new AGENT (Planning Consultant) for CouncilsOnline
