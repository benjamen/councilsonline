...
frappe.provide('councilsonline.status');

councilsonline.status.renderStatusPill = function(workflow_state) {
    if (!workflow_state) {
 ...
 */
councilsonline.status.getStatusColor = function(workflow_state) {
    const colorMap = {
        'Draft': 'gray',
        'Submitted': 'blue',
        'Acknowledged': 'cyan',
 ...
 */
councilsonline.status.renderStatusBadge = function(workflow_state) {
    const color = councilsonline.status.getStatusColor(workflow_state);
