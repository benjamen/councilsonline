#!/usr/bin/env python3
"""
Create sample data for CouncilsOnline
Run this with: bench --site councilsonline.localhost execute councilsonline.sample_data.create_all
"""
...
def create_all():
    ...
    print("\n" + "="*60)
    print("  COUNCILSONLINE SAMPLE DATA CREATION")
    print("="*60 + "\n")
