...
def execute():
    ...
    frappe.reload_doc("councilsonline", "doctype", "request_type")
    frappe.reload_doc("councilsonline", "doctype", "request_type_step_config")
    frappe.reload_doc("councilsonline", "doctype", "request_type_step_section")
    frappe.reload_doc("councilsonline", "doctype", "request_type_step_field")
