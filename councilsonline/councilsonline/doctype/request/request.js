...
function add_status_pill_to_header(frm) {
	...
	if (typeof councilsonline === 'undefined' || typeof councilsonline.status === 'undefined' || typeof councilsonline.status.renderStatusPill === 'undefined') {
		console.error('status_pill.js not loaded');
		return;
	}

	const status_pill_html = councilsonline.status.renderStatusPill(frm.doc.workflow_state);
...
function add_workflow_progression_indicator(frm) {
	...
	if (typeof councilsonline === 'undefined' || typeof councilsonline.workflow === 'undefined' || typeof councilsonline.workflow.renderWorkflowProgression === 'undefined') {
		console.error('workflow_progression.js not loaded');
		return;
	}

	const workflow_html = councilsonline.workflow.renderWorkflowProgression(
...
function render_status_card(frm) {
	...
	if (typeof councilsonline === 'undefined' || typeof councilsonline.status === 'undefined' || typeof councilsonline.workflow === 'undefined') {
	...
	// Build status pill
	const status_pill = councilsonline.status.renderStatusPill(frm.doc.workflow_state || 'Draft');

	// Build workflow progression
	const workflow_progression = councilsonline.workflow.renderWorkflowProgression(
...
function render_timeline_visual(frm) {
	...
	if (typeof councilsonline === 'undefined' || typeof councilsonline.timeline === 'undefined' || typeof councilsonline.timeline.renderTimelineVisual === 'undefined') {
	...
	// Render timeline
	const html = councilsonline.timeline.renderTimelineVisual(frm);
	field.$wrapper.html(html);
}
